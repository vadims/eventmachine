...
* Reactor Core: EventMachine
* Connections: EventMachine::Connection
* Examples: docs/examples.rdoc
* Features: docs/features.rdoc
* Protocols: Protocols[link:docs/protocols.rdoc]
* Release Notes: RELEASE_NOTES
* Change Log: ChangeLog[link:docs/ChangeLog]
* TODO: TODO[link:docs/TODO]
...
:include: docs/install.rdoc
:include: docs/introduction.rdoc

See link:docs/examples.rdoc for more usage samples.